...
const MostPopular = () => {
  ...
  return (
    <section className="pl-62 pr-62 container mx-auto px-6 py-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      {/* SOL GÖRSEL */}
      <div>
        <img
          src={image}
      ...
      <div className=" pl-10 max-w-2xs flex flex-col items-center space-y-4">
        ...
        {/* ÜRÜN BİLGİLERİ */}
        <div className="flex-col bg-white p-4 shadow-md rounded-lg flex items-center space-x-4">
          <img
            src={product.image}
            alt={product.name}
            className="w-20 h-20 object-cover rounded-lg"
          />
            <p className="text-gray-800 font-medium">{product.department}</p>
